...
const Card = ({ name, username, id }) => {
  ...
  return (
    <div className="card">
      ...
      <div>
        {!isFav ? <button onClick={() => addFav({ id: id, name: name, username: username })} className="favButton" >Favoritos</button> : <button onClick={() => removeFav({ id: id })} className="removeButton" >Quitar</button>}
      </div>
    </div>
  );
};
